...
const interviewReportSchema = z.object({
    title: z.string().describe("Extracted job title for this interview report"),
...
async function generateInterviewReport({ resume, selfDescription, jobDescription }) {
    const prompt = `Generate a JSON interview report from the candidate's resume, self-description, and job description.
